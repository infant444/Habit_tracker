...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.completeDate.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.completeDate);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.completeDate = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'completeDate',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      completeDateElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'completeDate',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'completeDate',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completeDateLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByCompleteDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'completeDate');
    });
  }
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<DateTime>, QQueryOperations> completeDateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'completeDate');
    });
  }
